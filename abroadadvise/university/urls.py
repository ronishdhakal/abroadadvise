...
from .views import (
    ...
    university_dashboard_view, update_university_dashboard, university_dropdown_list  # ✅ Import dashboard views
)
...
urlpatterns = [
    ...
    path('dropdown/', university_dropdown_list, name='university_dropdown_list'),

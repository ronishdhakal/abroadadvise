...
import EventCard from "@/pages/event/EventCard"; // Adjust path as needed
  ...
  return (
    <div className="bg-white p-5 rounded-xl shadow border border-gray-200">
      <h2 className="text-lg font-bold flex items-center gap-2 text-gray-800 mb-4">
        <CalendarDays className="h-5 w-5 text-[#4c9bd5]" />
        Upcoming Events
      </h2>
      ...
      {loading ? (
        ...
        <p className="text-sm text-gray-500">No active events from this consultancy.</p>
      ) : (

    ...
    <div className="w-full max-w-md bg-white shadow-md rounded-xl p-6 border border-gray-200">
      ...
      <div className="flex items-center gap-3 text-gray-800 text-sm mb-4">
        ...
        <div>
          ...
          <span className="font-semibold text-gray-800">{course.duration || "N/A"}</span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3 text-gray-800 text-sm mb-4">
        ...
        <div>
          ...
          <span className="font-semibold text-gray-800">{course.level || "N/A"}</span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3 text-gray-800 text-sm">
        ...
        <div>
          ...
          <span className="font-semibold text-gray-800">{course.fee || "Contact for Pricing"}</span>
        </div>
      </div>
    </div>
  )

  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (data.college_id) {
        ...
        console.error("❌ College ID is missing in response!");
      }
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#4c9bd5] focus:border-transparent transition"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-500 hover:text-[#4c9bd5] transition"
                >
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-[#4c9bd5] border-gray-300 rounded focus:ring-[#4c9bd5] transition"
                />
                <label htmlFor="remember-me" className="ml-2 text-sm text-gray-600 font-light">
                  Remember Me
                </label>
              </div>
              <a href="#" className="text-sm text-[#4c9bd5] font-light hover:underline">
                Forgot Password?
              </a>
            </div>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-3 px-4 bg-gradient-to-r from-[#4c9bd5] to-[#3a89c3] text-white rounded-lg text-sm font-light tracking-wide shadow-md hover:shadow-lg transition"
            >
              Log In
            </motion.button>
          </form>

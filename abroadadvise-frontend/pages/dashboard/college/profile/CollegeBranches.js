...
const CollegeBranches = ({ formData, setFormData, onUpdate }) => {
  ...
  return (
    <div className="p-6 bg-white shadow-lg rounded-xl">
      <h2 className="text-xl font-bold text-gray-800 mb-4">College Branches</h2>
...
export default CollegeBranches;

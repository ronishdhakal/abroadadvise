        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mt-8 flex flex-col md:flex-row items-center justify-between text-gray-600 text-sm">
            ...
            <div className="flex space-x-4 mt-4 md:mt-0">
              <a href="https://www.facebook.com/abroadadvisefb/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 text-lg">
                <FaFacebookF />
              </a>
              <a href="https://x.com/collegenepal?lang=en" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 text-lg">
                <FaTwitter />
              </a>
              <a href="https://www.instagram.com/collegeinfonp/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 text-lg">
                <FaInstagram />
              </a>
              <a href="https://www.linkedin.com/company/abroadadvise" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 text-lg">
                <FaLinkedin />
              </a>
